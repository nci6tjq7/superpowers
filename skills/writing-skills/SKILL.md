...
**Personal skills live in agent-specific directories (`~/.claude/skills` for Claude Code, `~/.agents/skills/` for Codex, platform-specific paths for other environments)** 
...
- Project-specific conventions (put in AGENTS.md or platform-specific instruction file)
